...
def make_replace_dict(quote):
    replace_dict = make_space_replace_dict() | make_punct_replace_dict()
    replace_dict = replace_dict | make_digraph_replace_dict()
    if quote:
        replace_dict = replace_dict | make_quote_replace_dict()
    return replace_dict
